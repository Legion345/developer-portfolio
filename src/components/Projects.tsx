...
export function Projects() {
  ...
  const myProjects = [
    ...
    },
    {
      ...
      description:
        "A collaborative task management REST API with real-time updates, and to settle any differences between two parties.",
            ...
            return (
              ...
              >
                ...
                <div className={isLarge ? "lg:p-4 p-6" : "p-6"}>
                  ...
                  <p
                    className={`text-gray-600 mb-4 ${isLarge ? "lg:text-xs lg:leading-snug" : "text-sm"} leading-relaxed`}
                  >
                    {project.description}
                  </p>
